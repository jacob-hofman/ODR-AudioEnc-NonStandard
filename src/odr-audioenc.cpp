...
constexpr std::array<uint8_t, 256> itel_bytemap_v5 = {
    
};

constexpr std::array<uint8_t, 256> itel_bytemap_v6 = {
    
};
...
static void usage(const char* name)
{
    ...
    "   Non-standard compatibility options:\n"
...
private:
    ...
    void apply_itel_bytemap(vec_u8& buf);
};

void AudioEnc::set_itel_version(int v)
{
    m_itel_version = v;
    edi_output.set_itel_version(v);
}

void AudioEnc::apply_itel_bytemap(vec_u8& buf)
{
    if (m_itel_version == 5) {
        std::for_each(buf.begin(), buf.end(), [&](uint8_t &i){
            i = itel_bytemap_v5[i];
        });
...
int main(int argc, char *argv[])
{
    const struct option longopts[] = {
        ...
        {"itel-v5",                no_argument,        0, 13 },
        {"itel-v6",                no_argument,        0, 14 },
        {0, 0, 0, 0},
    };
    ...
    while(ch != -1) {
        ...
        case 'V':
            ...
            break;
        case 13: // --itel-v5
            audio_enc.set_itel_version(5);
            break;
        case 14: // --itel-v6
            audio_enc.set_itel_version(6);
            break;
        case '?':
        case 'h':
            usage(argv[0]);
